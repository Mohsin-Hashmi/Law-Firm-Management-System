...
import { Form, Input, Select, Button, Typography, Card, Spin, Avatar, Steps, Progress, Divider, Space } from "antd";
import {
  MailOutlined,
  PhoneOutlined,
  UserOutlined,
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ position: "relative", display: "inline-block" }}>
                  {previewUrl ? (
                    ...
                    >
                      <CameraOutlined style={{ fontSize: "40px", color: "#94a3b8" }} />
                    </Avatar>
                  )}
                ...
                <div style={{ marginTop: "20px" }}>
                  <Text style={{ fontSize: "16px", color: "#374151", fontWeight: "600", display: "block" }}>
                    Professional Profile Photo
                  </Text>
                  <Text style={{ fontSize: "14px", color: "#9ca3af", marginTop: "4px" }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <div style={{ marginBottom: "24px" }}>
                    <Title level={4} style={{ color: "#374151", marginBottom: "4px", fontSize: "18px" }}>
                      <IdcardOutlined style={{ marginRight: "8px", color: "#1e40af" }} />
                  ...
                  <Form.Item
                    label={<span style={{ fontSize: "15px", fontWeight: "600", color: "#374151" }}>Full Name</span>}
                    name="name"
                    rules={[{ required: true, message: "Please enter the attorney's full name" }]}
                  >
                    <Input
                ...
                <div>
                  ...
                  <Form.Item 
                    label={<span style={{ fontSize: "15px", fontWeight: "600", color: "#374151" }}>Legal Specialization</span>}
                    name="specialization"
                  >
                    <Select
                  ...
                  <Form.Item
                    label={<span style={{ fontSize: "15px", fontWeight: "600", color: "#374151" }}>Employment Status</span>}
                    name="status"
                  ...
                  <div style={{
                    ...
                    <Title level={5} style={{ color: "#1e40af", marginBottom: "8px", fontSize: "16px" }}>
                      Account Setup Information
                    </Title>
                    <Text style={{ color: "#334155", fontSize: "14px", lineHeight: "1.6" }}>
                      The attorney will receive login credentials via email upon successful registration. 
                      They can update their profile and change their password after first login.
                    </Text>
                  </div>
                </div>
              </div>
