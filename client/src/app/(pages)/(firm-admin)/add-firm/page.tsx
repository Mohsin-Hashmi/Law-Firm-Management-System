  ...
  const handleCreateFirm = async () => {
    try {
      ...
      if (msg?.toLowerCase().includes("email")) {
        toast.error(
          "A firm with this email already exists. Please use a different email."
        );
      } else if (msg?.toLowerCase().includes("name")) {
        toast.error(
          "A firm with this name already exists. Please choose a different name."
        );
      } else {
        toast.error(msg || "Something went wrong while creating the firm");
      }
    } finally {
      setLoading(false);
    }
                      ...
                      <div style={{ display: "flex", gap: "16px" }}>
                        ...
                        >
                          <InputNumber
                            ...
                            min={1}
                            max={
                              getMaxLimitsForPlan(subscription_plan).maxUsers
                            }
                            value={maxUsers}
                        ...
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: "Please enter max cases",
                            },
                          ]}
                          style={{ flex: 1 }}
                        >
                          <InputNumber
                            ...
                            min={1}
                            max={
                              getMaxLimitsForPlan(subscription_plan).maxCases
                            }
                            value={maxCases}
                  ...
                  <div style={{ textAlign: "center" }}>
                    ...
                    <div style={{ marginTop: "24px" }}>
                      <Text
                        ...
                        style={{ fontSize: "14px" }}
                      >
                        Your firm will be ready to use immediately after
                        creation
                      </Text>
                    </div>
                  </div>
