  ...
  const getActionMenuItems = (lawyer: Lawyer) => [
    {
      ...
      onClick: () => {
        ...
        router.push(`/firm-admin/get-lawyer-detail/${lawyer.id}`);
      },
    },
    {
      key: "edit",
      ...
      onClick: () => {
        ...
        router.push(`/firm-admin/edit-lawyer/${lawyer.id}`);
      },
    },
    {
      key: "delete",
        ...
        <Space size="small">
          <Tooltip title="View Details">
            <Button
              ...
              icon={<EyeOutlined />}
              onClick={() =>
                router.push(`/firm-admin/get-lawyer-detail/${record.id}`)
              }
          ...
          <Tooltip title="Edit Lawyer">
            <Button
              ...
              icon={<EditOutlined />}
              onClick={() =>
                router.push(`/firm-admin/edit-lawyer/${record.id}`)
              }
                  ...
                  <Col >
                    <Space size="middle">
                      <Button
                        ...
                        onClick={() => router.push("/firm-admin/add-lawyer")}
                        style={{
                          background: "white",
                          borderColor: "white",
                          color: "#2563eb",
